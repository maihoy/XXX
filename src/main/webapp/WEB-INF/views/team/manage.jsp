    ...
    <div class="container">
            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<c:url value='/comment/list' />">Комметарии</a></li>
                        <li class="dropdown">
        ...
        <div class="container " >
            ...
            <form:form method="POST" modelAttribute="team">
                ...
                <table class=" table">
                    <tr>
                        <td style="line-height: 2" class="col-sm-2 control-label"><label for="name">Название: </label> </td>
                    ...
                    <tr>
                        <td style="line-height: 2" class="col-sm-2 control-label"><label for="shortName">Сокращение: </label> </td>
                    ...
                    <tr>
                        <td style="line-height: 2" class="col-sm-2 control-label"><label for="notes">Описание: </label> </td>
            ...
            <br/>
            <br/>
            Вернуться к <a href="<c:url value='/team/list' />">Списку всех Команд</a>
        </div>
    </div>
</body>
</html>
