        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="<c:url value='/team/list' />">Команды<span class="sr-only">(current)</span></a></li>
                    <li><a href="<c:url value='/player/list' />">Игроки</a></li>
                    <li><a href="<c:url value='/comment/list' />">Комментирии</a></li>
                    <li class="dropdown">
...
<sec:authorize access="hasRole('ADMIN') or hasRole('USER')">
    ...
    <div class="table-responsive">
        <table class="table table-hover filtered sortable" id="sortabletable">
            <thead>
                <tr>
                    <th>Название</th><th>Сокращение</th><th class="unsortable">Описание</th>
                    <sec:authorize access="hasRole('ADMIN') or hasRole('USER')">
            ...
            <c:forEach items="${teams}" var="team">
                <tr>
                    ...
                    <td>${team.notes}</td>
                    <sec:authorize access="hasRole('ADMIN') or hasRole('USER')">
                    <td><input class="btn btn-warning btn-xs" value="Изменить" onclick="location.href='edit-${team.id}-team'" type="button" /></td>
                    <td><input class="btn btn-danger btn-xs" value="Удалить" onclick="location.href='delete-${team.id}-team'" type="button" /></td>
                    </sec:authorize>
                </tr>
            </c:forEach>
            </tbody>
