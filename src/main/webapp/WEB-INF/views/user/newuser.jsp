...
<div class="container">
	...
	<div class="container " >
		...
		<form:form method="POST" modelAttribute="user">
			...
			<table class=" table">
				<tr>
					<td style="line-height: 2" class="col-sm-2 control-label"><label for="firstName">Имя: </label> </td>
				...
				<tr>
					<td style="line-height: 2" class="col-sm-2 control-label"><label for="lastName">Фамилия: </label> </td>
				...
				<tr>
					<td style="line-height: 2" class="col-sm-2 control-label"><label for="password">Пароль: </label> </td>
				...
				<tr>
					<td style="line-height: 2" class="col-sm-2 control-label"><label for="roles">Роль: </label> </td>
		...
		<br/>
		<br/>
		Вернуться к <a href="<c:url value='/user/list' />">Списку всех пользователей</a>
	</div>
</div>
</body>
</html>
